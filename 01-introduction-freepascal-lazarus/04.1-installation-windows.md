...
**Pour Windows 32 bits ou compatibilité maximale** :
...
**Pour une installation standard** : Gardez tout coché sauf associations (si vous avez Delphi).
