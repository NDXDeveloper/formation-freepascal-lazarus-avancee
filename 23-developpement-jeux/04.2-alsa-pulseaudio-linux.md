...
**Note** : PipeWire peut émuler l'API PulseAudio, donc le code PulseAudio fonctionnera avec PipeWire.
...
## OpenAL - Solution multi-plateforme recommandée
...
✅ **OpenAL** : Recommandé pour les jeux (multi-plateforme)  
